...
public class ButtonFragment extends BaseFragment implements PagerAdapterPageEvent {
    ...
    private ArrayList<ChoiceDTO> mChoices;
    ...
    public static ButtonFragment newInstance(String question, ArrayList<ChoiceDTO> choices, int position) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(this.getArguments() != null){
            ...
            mChoices = (ArrayList<ChoiceDTO>) args.getSerializable(CHOICES);
...
//        if(mcAnswer == null){
//            DataHolder.getAnswersDTO().getMcAnswers().add(new MultipleChoiceAnswerDTO(mQuestion, DataHolder.retrieveChoiceByGrade(mQuestion, 0)));
//        }
...
//                }
                ...
                for (MultipleChoiceAnswerDTO dto : DataHolder.getAnswersDTO().getMcAnswers()){
...
//        }
    ...
    private class InnerOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            MultipleChoiceAnswerDTO dto = DataHolder.isMcQuestionAnswered(mQuestion);

            // remove \n commands from "no comment" button
            String choiceText = ((Button) view).getText().toString().replaceAll("\\n", "");

            if(dto == null){
                ChoiceDTO choiceDTO = DataHolder.retrieveChoiceDTO(mQuestion,choiceText);
                DataHolder.getAnswersDTO().getMcAnswers().add(new MultipleChoiceAnswerDTO(mQuestion, choiceDTO));
            } else {
                ChoiceDTO choiceDTO = DataHolder.retrieveChoiceDTO(mQuestion, choiceText);
                dto.setChoice(choiceDTO);
            }
